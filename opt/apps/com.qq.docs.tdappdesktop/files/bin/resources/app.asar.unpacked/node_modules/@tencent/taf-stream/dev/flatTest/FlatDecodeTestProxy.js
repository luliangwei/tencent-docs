...
// Generated from `/data/NodejsServer/NodejsDeployServer/jce/uploads/1508723390063/in/DecodeTest.jce'
// **********************************************************************
...
DecodeTest.TestStruct = function(inputStream) {
    this._inputStream = inputStream;
    //this._originPosition = undefined;
    this._originPosition = 0;
    this._unreadPropNum = 12;
...
DecodeTest.TestStruct.prototype.KeepPosition = function (readFn) {
...
DecodeTest.TestStruct.prototype.__defineGetter__("int1", function () {
...
DecodeTest.TestStruct.prototype.__defineSetter__("int1", function (value) {
    this._int1 = value;
});

DecodeTest.TestStruct.prototype.__defineGetter__("int2", function () {
...
DecodeTest.TestStruct.prototype.__defineSetter__("int2", function (value) {
    this._int2 = value;
});

DecodeTest.TestStruct.prototype.__defineGetter__("str1", function () {
...
DecodeTest.TestStruct.prototype.__defineSetter__("str1", function (value) {
    this._str1 = value;
});

DecodeTest.TestStruct.prototype.__defineGetter__("str2", function () {
...
DecodeTest.TestStruct.prototype.__defineSetter__("str2", function (value) {
    this._str2 = value;
});
...
DecodeTest.TestStruct._readFrom = function (is) {
    var tmp = new DecodeTest.TestStruct(is);
