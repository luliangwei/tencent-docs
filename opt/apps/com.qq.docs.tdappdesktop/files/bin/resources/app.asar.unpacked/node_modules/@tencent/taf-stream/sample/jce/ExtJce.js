...
Ext.ExtInfo = function() {
    this.sUserName = "";
    this.data = new Taf.Map(Taf.String, Taf.BinBuffer);
    this.cons = new Taf.Map(Taf.String, Taf.Map(Taf.String, Taf.BinBuffer));
};
...
Ext.ExtInfo._readFrom = function (is) {
    ...
    tmp.sUserName = is.readString(0, false, Taf.String);
    tmp.data = is.readMap(1, false, Taf.Map(Taf.String, Taf.BinBuffer));
    tmp.cons = is.readMap(2, false, Taf.Map(Taf.String, Taf.Map(Taf.String, Taf.BinBuffer)));
    return tmp;
};
